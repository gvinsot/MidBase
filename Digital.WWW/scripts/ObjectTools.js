...
(function (TypeScriptTools) {
    var ObjectTools = (function () {
        ...
        ObjectTools.ConvertJsonToDate = function ConvertJsonToDate(sourceString) {
            var trimed = TypeScriptTools.FileTools.TrimStart(sourceString, "/Date(");
            trimed = TypeScriptTools.FileTools.TrimEnd(trimed, ")/");
            trimed = TypeScriptTools.FileTools.TrimEnd(trimed, "+0000");
            return new Date(parseInt(trimed));
        };
        ObjectTools.ConvertJsonTimeSpanToDate = function ConvertJsonTimeSpanToDate(sourceString) {
            var trimed = TypeScriptTools.FileTools.TrimStart(sourceString, "PT");
            var hours = 0;
            var minutes = 0;
            var seconds = 0;
            ...
            trimed = TypeScriptTools.FileTools.TrimEnd(trimed, "S");
